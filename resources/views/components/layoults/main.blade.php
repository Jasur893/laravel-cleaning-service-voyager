        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="{{ route('services') }}"><i
                        class="fa fa-angle-right mr-2"></i>{{__('Services')}}</a>
                <a class="text-white mb-2" href="{{ route('projects') }}"><i
                        class="fa fa-angle-right mr-2"></i>{{__('Portfolio')}}</a>
                <a class="text-white" href="{{ route('contact') }}"><i
                        class="fa fa-angle-right mr-2"></i>{{__('Contacts')}}</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-5">
